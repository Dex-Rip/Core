...
// RipMaker is MasterRip's left hand and kinda a wizard. He can cook up Rip from pretty much anything!
// This contract handles "serving up" rewards for xRip holders by trading tokens collected from fees for Rip.

// T1 - T4: OK
contract RipMaker is BoringOwnable {
    ...
    function setBridge(address token, address bridge) external onlyOwner {
        // Checks
        require(
            token != Rip && token != wavax && token != bridge,
            "RipMaker: Invalid bridge"
        );
    ...
    modifier onlyEOA() {
        ...
        require(msg.sender == tx.origin, "RipMaker: must use EOA");
        _;
    }
    ...
    function _convert(address token0, address token1) internal {
        ...
        require(address(pair) != address(0), "RipMaker: Invalid pair");
        // balanceOf: S1 - S4: OK
        // transfer: X1 - X5: OK
    ...
    function _swap(
        ...
        require(address(pair) != address(0), "RipMaker: Cannot convert");
    ...
    // F1 - F10: OK
    // C1 - C24: OK
    function _toRip(address token, uint256 amountIn)
        internal
