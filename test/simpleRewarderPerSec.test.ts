...
describe("simple rewarder per seconds", function () {
  before(async function () {
    ...
    let PairCF = await ethers.getContractFactory("RipPair")
    let MCV3CF = await ethers.getContractFactory("MasterChefRipV3")
    ...
    this.Rip = await ERC20MockDecimalsCF.deploy(18)
  ...
  beforeEach(async function () {
    ...
    this.simpleRewarderPerSec = await this.simpleRewarderPerSecCF.deploy(this.Rip.address, USTWAVAX_ADDRESS, "450", this.MCV3.address, false)
