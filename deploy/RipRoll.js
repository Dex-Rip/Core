...
module.exports = async function ({
  ...
  const RipRouterAddress = (await deployments.get("RipRouter02")).address;

  await deploy("RipRoll", {
    from: deployer,
    args: [pangolinRouterAddress, RipRouterAddress],
    log: true,
    deterministicDeployment: false,
  });
};

module.exports.tags = ["RipRoll"];
module.exports.dependencies = ["RipRouter02"];
